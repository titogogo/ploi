    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({ title: "Create new gateway" }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="py-4 container-fluid"${_scopeId}><div class="row"${_scopeId}><div class="col-12"${_scopeId}><div class="multisteps-form"${_scopeId}><div class="row"${_scopeId}><div class="mx-auto mt-4 mb-3 col-12 col-lg-8 mb-sm-5"${_scopeId}><div class="multisteps-form__progress"${_scopeId}><button class="multisteps-form__progress-btn js-active js-active position-relative" type="button" title="Gateway Info"${_scopeId}><span${_scopeId}>1. Gateway Information</span></button>`);
            ...
            if (unref(form).type === "smpp") {
              ...
              _push2(`</div></div><div class="row"${_scopeId}><div class="col-12 col-sm-12"${_scopeId}><label${_scopeId}>Sender</label>`);
              _push2(ssrRenderComponent(_sfc_main$2, {
                class: "multisteps-form__input",
                modelValue: unref(form).sender,
                "onUpdate:modelValue": ($event) => unref(form).sender = $event,
                id: "sender",
                type: "text",
                "aria-label": "Sender",
                error: unref(form).errors.hasOwnProperty("sender")
              }, null, _parent2, _scopeId));
              _push2(ssrRenderComponent(_sfc_main$3, {
                class: "mt-2",
                message: unref(form).errors.sender
              }, null, _parent2, _scopeId));
              _push2(`</div></div><!--]-->`);
            } else {
              _push2(`<!---->`);
            ...
            _push2(`</div></div></div>`);
            if (unref(form).type === "http") {
              _push2(`<div class="p-3 bg-white card multisteps-form__panel border-radius-xl" data-animation="FadeIn"${_scopeId}><h5 class="font-weight-bolder"${_scopeId}>Parameters</h5><div class="multisteps-form__content"${_scopeId}><!--[-->`);
              ...
              _push2(`<!--]--><div class="m-auto mt-4 text-center"${_scopeId}><button class="m-auto btn mb-0 bg-gradient-success btn-sm null null px-7" title="add"${_scopeId}>Add </button></div><div class="mt-5 button-row d-flex col-12"${_scopeId}><button class="btn mb-0 bg-gradient-secondary btn-md null null mb-0 js-btn-prev" title="Prev"${_scopeId}>Prev </button><button class="btn mb-0 bg-gradient-dark btn-md null null mb-0 ms-auto js-btn-next" type="button" title="Next"${_scopeId}>Next </button></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (unref(form).type === "http") {
            ...
            _push2(`</form></div></div></div></div></div></div>`);
          } else {
            return [
                      ...
                      createVNode("div", { class: "row" }, [
                        createVNode("div", { class: "m-auto col-12 col-lg-8" }, [
                          createVNode("form", {
                            ...
                            unref(form).type === "http" ? (openBlock(), createBlock("div", {
                              key: 0,
                              ...
                              createVNode("div", { class: "multisteps-form__content" }, [
                                (openBlock(true), createBlock(Fragment, null, renderList(unref(form).params, (param, i) => {
                                  return openBlock(), createBlock(GatewayParam, {
                                    ...
                                    key: param.id,
                                    name: param.type === "token" ? "authorization" : ""
                                  }, null, 8, ["has-name", "has-value", "type", "deletable", "index", "nullable", "name"]);
                                }), 128)),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Gateway/Create.vue");
