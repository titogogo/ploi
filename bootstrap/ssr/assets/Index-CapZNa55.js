import { inject, mergeProps, withCtx, createTextVNode, toDisplayString, openBlock, createBlock, unref, createVNode, useSSRContext } from "vue";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({ title: "Payment Logs" }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="py-4 container-fluid"${_scopeId}><div class="row"${_scopeId}><div class="col-12"${_scopeId}><div class="card"${_scopeId}><div class="pb-0 card-header"${_scopeId}><div class="d-lg-flex"${_scopeId}><div${_scopeId}><h5 class="mb-0"${_scopeId}>Payment Logs</h5></div></div></div><div class="px-0 pb-0 card-body"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$2, {
              data: __props.paymentLogs,
              columns,
              checkbox: true,
              actions,
              onOnDeleteManyClicked: onDeleteManyClicked
            }, {
              ...
              status: withCtx(({ data }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  return [
                    data.status === "APPROVED" ? (openBlock(), createBlock("div", {
                      key: 0,
                      class: "badge bg-success"
                    }, toDisplayString(data.status), 1)) : (openBlock(), createBlock("div", {
                      key: 1,
                      class: "badge bg-info"
                    }, toDisplayString(data.status), 1))
                  ];
                }
              }),
                      ...
                      createVNode("div", { class: "pb-0 card-header" }, [
                        createVNode("div", { class: "d-lg-flex" }, [
                          createVNode("div", null, [
                            createVNode("h5", { class: "mb-0" }, "Payment Logs")
                          ])
                        ])
                      ]),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Payment/Index.vue");
