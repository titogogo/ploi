...
import SessionsForm from "@/Pages/Profile/Partials/SessionsForm.vue";
        ...
        <div class="container-fluid mt-4">
            <div class="row mb-5">
                ...
                <div class="col-lg-9 mt-lg-0 mt-4">
                    <div id="profile" class="card card-body mt-4">
                        <div class="row justify-content-center align-items-center">
                            <div class="col-sm-auto col-4">
                                <div class="avatar avatar-xl"><img :src="$page.props.auth.user.profile_photo_url"
                                                                   alt="bruce" class="shadow-sm null border-radius-lg">
                                </div>
                            </div>
                            <div class="col-sm-auto col-8 my-auto">
                                <div class="h-100">
                                    <h5 class="mb-1 font-weight-bolder">{{ $page.props.auth.user.name }}</h5>
                                </div>
                            </div>
                            <div class="col-sm-auto ms-sm-auto mt-sm-0 mt-3 d-flex">
                                <h5 class="mb-1 font-weight-bold">Balance: {{
                                        $page.props.auth.user.balance.formatted
                                    }}</h5>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="">
                                            <!----><input id="confirmEmail" type="email"
                                                          class="form-control form-control-default" name=""
                                                          placeholder="example@email.com" isrequired="false"><!---->
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <sessions-form :sessions="sessions"/>
                    ...
                    <div id="delete" class="card mt-4">
                        ...
                        <div class="card-body d-sm-flex pt-0">
                            <div class="d-flex align-items-center mb-sm-0 mb-4">
                                <div>
                                    <div class="form-check form-switch"><input id="deleteAccount"
                                                                               class="form-check-input" type="checkbox"
                                                                               name="deleteAccount"><label
                                        class="form-check-label" for="deleteAccount"></label></div>
                                </div>
                                <div class="ms-2"><span
                                    class="text-dark font-weight-bold d-block text-sm">Confirm</span><span
                                    class="text-xs d-block">I want to delete my account.</span></div>
                            </div>
                            <button class="btn mb-0 btn-outline-secondary btn-md null null mb-0 ms-auto" type="button"
                                    name="button">Deactivate
                            </button>
                            <button class="btn mb-0 bg-gradient-danger btn-md null null mb-0 ms-2" type="button"
