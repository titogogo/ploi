...
onMounted(() => {
    initMultiStepForm()
    authTypeChange()
    addParam('source', 'source', true, true, false)
    addParam('destination', 'source', true, false, false)
    addParam('message', 'message', true, false, false)
    addParam('unicode', 'Unicode', true, true, false, true)
})
...
const form = useForm({
    ...
    encoding_type: encodingTypes[0],
    ignore_ssl: true,
    authorization_type: authTypes[0] ?? null,
    ip_address: '',
    port: 1,
    username: '',
    password: '',
    ...
    cost: 0,
    delay: 1,
    delay_type: delayTypes[0] ?? null,
    enabled: true,
    params: [],
});

const submit = () => {
    form.post(route('gateway.store'), {
        onSuccess: () => {
            swal.fire({
                title: "Success!",
...
const authTypeChange = () => {
    if (form.authorization_type === 'param' || form.authorization_type === 'header') {
        removeAuthInputs()
    ...
    if (form.authorization_type === 'bearer_token') {
        ...
        insertParam('token', 'token', true, true, false, true)
    }
}
...
const insertParam = (type, name, hasName, hasValue, removable, nullable = true) => {
...
const addParam = (type = 'custom', name = 'custom param', hasName = true, hasValue = true, removable = true, nullable = false) => {
    let latestId = form.params.reduce((acc, value) => {
        return (acc = acc > value.id ? acc : value.id);
    }, 0);
                            ...
                            <div class="mx-auto mt-4 mb-3 col-12 col-lg-8 mb-sm-5">
                                <div class="multisteps-form__progress">
                                    <button class="multisteps-form__progress-btn js-active js-active position-relative"
                                            type="button" title="Gateway Info"><span>1. Gateway Information</span>
                                    </button>
                                ...
                                <form class="mb-8 multisteps-form__form" role="form" @submit.prevent="submit">
                                        ...
                                        <div class="multisteps-form__content">
                                            ...
                                            <template v-if="form.type === 'http'">
                                                ...
                                                <div class="row">
                                                    <div class="col-12 col-sm-12">
                                                        ...
                                                        />
                                                        <InputError class="mt-2" :message="form.errors.success_keyword" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-12 col-sm-12">
                                                        ...
                                                        <select v-model="form.method_type" class="form-control" name="choices-method-type" id="choices-method-type">
                                                            <option :value="methodType" v-for="(methodType, i) in methodTypes" :key="i">{{ methodType }}</option>
                                                        </select>
                                                ...
                                                <div class="mt-3 row">
                                                    <div class="col-12 col-sm-12">
                                                        ...
                                                        <select v-model="form.json_encoded" class="form-control" name="choices-json-encoded" id="choices-json-encoded">
                                                ...
                                                <div class="mt-3 row">
                                                    <div class="col-12 col-sm-12">
                                                        ...
                                                        <select v-model="form.content_type" class="form-control" name="choices-content-types" id="choices-content-types">
                                                            <option :value="contentType" v-for="(contentType, i) in contentTypes" :key="i">{{ contentType }}</option>
                                                        </select>
                                                ...
                                                <div class="mt-3 row">
                                                    <div class="col-12 col-sm-12">
                                                        ...
                                                        <select v-model="form.accept" class="form-control" name="choices-accept-content-type" id="choices-accept-content-type">
                                                            <option :value="contentType" v-for="(contentType, i) in contentTypes" :key="i">{{ contentType }}</option>
                                                        </select>
                                                ...
                                                <div class="mt-3 row">
                                                    <div class="col-12 col-sm-12">
                                                        ...
                                                        <select v-model="form.encoding_type" class="form-control" name="choices-encoding" id="choices-encoding">
                                                            <option :value="encoding" v-for="(encoding, i) in encodingTypes" :key="i">{{ encoding }}</option>
                                                        </select>
                                                ...
                                                <div class="mt-3 row">
                                                    <div class="col-12 col-sm-12">
                                                        ...
                                                        <select v-model="form.ignore_ssl" class="form-control" name="choices-ignore-ssl" id="choices-ignore-ssl">
                                                            <option :value="true">Yes</option>
                                                            <option :value="false">No</option>
                                                        </select>
                                                ...
                                                <div class="mt-3 row">
                                                    <div class="col-12 col-sm-12">
                                                        ...
                                                        <select v-model="form.authorization_type" class="form-control" name="choices-authorization-type" id="choices-authorization-type" @change="authTypeChange">
                                                            <option :value="authType" v-for="(authType, i) in authTypes" :key="i">{{ authType }}</option>
                                                        </select>
                                                        <InputError class="mt-2" :message="form.errors.authorization_type" />
                                                    </div>
                                                </div>
                                            </template>
                                                ...
                                                <div class="row">
                                                    <div class="col-12 col-sm-12">
                                                        ...
                                                        <soft-input
                                                            ...
                                                            type="text"
                                                            aria-label="Sender"
                                                            :error="form.errors.hasOwnProperty('sender')"
                                                        />
                                                        <InputError class="mt-2" :message="form.errors.sender" />
                                                    </div>
                                                </div>
                                            </template>
                                            ...
                                            <div class="mt-3 row">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input v-model="form.cost" type="number" class="form-control" aria-label="Cost" step="0.01">
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-sm-12">
                                                    ...
                                                    <select v-model="form.delay_type" class="form-control" name="choices-delay-unit" id="choices-delay-unit" @change="authTypeChange">
                                                        <option :value="delayType" v-for="(delayType, i) in delayTypes" :key="i">{{ delayType }}</option>
                                                    </select>
                                            ...
                                            <div class="mt-4 row">
                                                <div class="col-12 col-sm-12">
                                                    <soft-switch v-model="form.enabled" id="enabled" name="enabled" checked>
                                    ...
                                    <div
                                        ...
                                        <div class="multisteps-form__content">
                                            <gateway-param
                                                ...
                                                :key="param.id"
                                                :name="param.type === 'token' ? 'authorization' : ''"
                                            />
                                    ...
                                    <div
                                        ...
                                        <div class="multisteps-form__content">
                                            <div class="row mt-3">
                                                <div class="col-12 col-sm-12">
                                                    <label>Response JSON Message Key <span class="text-xs text-secondary">(You can use . notion)</span> </label>
                                                    <soft-input
                                                        class="multisteps-form__input "
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-sm-12">
                                                    <label>Webhook JSON Message Key <span class="text-xs text-secondary">(You can use . notion)</span> </label>
                                                    <soft-input
                                                        class="multisteps-form__input "
                                                    ...
                                                    />
                                                    <InputError class="mt-2" :message="form.errors.webhook_json_message_key" />
                                                </div>
                                            </div>

                                            <div class="row">
                                                <div class="col-12 col-sm-12">
                                                    <label>Webhook JSON Status Key <span class="text-xs text-secondary">(You can use . notion)</span> </label>
                                                    <soft-input
                                                        class="multisteps-form__input "
                                                    ...
                                                    />
                                                    <InputError class="mt-2" :message="form.errors.webhook_json_status_key" />
                                                </div>
                                            </div>
